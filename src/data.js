export const projectData = [
  ...
  },
  {
    ...
    name: "ACTION ATM",
    description:
      "Designed and coded a virtual ATM machine which logged user data (withdrawals, deposits, transfers, transaction history) for a UMGC project.",
    tech: "Java, XML, AdobeXD",
    image: "../images/atm_thumbnail.png",
    url: "",
    github: "https://github.com/jdk301/atm",
  },
  {
    id: 3,
    name: "Fire Tracker",
    description:
      "A Python program built during my internship at the EIA that mapped active fires and track their proximities to energy infrastructures in the US.",
    tech: "Python, NumPy, pandas, QGIS",
    image: "../images/fire_thumbnail.png",
    url: "",
    github: "",
  },
];
